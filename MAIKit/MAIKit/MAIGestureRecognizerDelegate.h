...
@optional
-(BOOL)gestureRecognizerShouldBegin:(id<MAIGestureRecognizerProtocol>)gestureRecognizer;
-(BOOL)gestureRecognizer:(id<MAIGestureRecognizerProtocol>)gestureRecognizer shouldRecognizeSimultaneouslyWithGestureRecognizer:(id<MAIGestureRecognizerProtocol>)otherGestureRecognizer;
-(BOOL)gestureRecognizer:(id<MAIGestureRecognizerProtocol>)gestureRecognizer shouldRequireFailureOfGestureRecognizer:(id<MAIGestureRecognizerProtocol>)otherGestureRecognizer;
-(BOOL)gestureRecognizer:(id<MAIGestureRecognizerProtocol>)gestureRecognizer shouldBeRequiredToFailByGestureRecognizer:(id<MAIGestureRecognizerProtocol>)otherGestureRecognizer;
