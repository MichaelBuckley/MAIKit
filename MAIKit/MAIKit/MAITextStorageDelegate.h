...
@optional
-(void)textStorage:(id<MAITextStorageProtocol>)textStorage willProcessEditing:(MAITextStorageEditActions)editedMask range:(NSRange)editedRange changeInLength:(NSInteger)delta;
-(void)textStorage:(id<MAITextStorageProtocol>)textStorage didProcessEditing:(MAITextStorageEditActions)editedMask range:(NSRange)editedRange changeInLength:(NSInteger)delta;
