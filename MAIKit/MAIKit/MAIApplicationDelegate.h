...
@optional
-(void)application:(id<MAIApplicationProtocol>)application didRegisterForRemoteNotificationsWithDeviceToken:(NSData*)deviceToken;
-(void)application:(id<MAIApplicationProtocol>)application didFailToRegisterForRemoteNotificationsWithError:(NSError*)error;
