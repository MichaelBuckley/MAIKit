...
#else
+(instancetype)segmentedControlWithLabels:(NSArray<NSString*>*)labels trackingMode:(NSSegmentSwitchTracking)trackingMode target:(nullable id)target action:(nullable SEL)action NS_UNAVAILABLE;
+(instancetype)segmentedControlWithImages:(NSArray<MAIImage*>*)images trackingMode:(NSSegmentSwitchTracking)trackingMode target:(nullable id)target action:(nullable SEL)action NS_UNAVAILABLE;
...
#if TARGET_OS_IPHONE
@interface MAISegmentedControl : UISegmentedControl<MAISegmentedControlProtocol>
#else
@interface MAISegmentedControl : NSSegmentedControl<MAISegmentedControlProtocol>
#endif
@end
