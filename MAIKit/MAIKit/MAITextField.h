...
@property(nullable, setter=setTextColor:, getter=textColor) MAIColor* textColor;
@property(nullable, setter=setFont:, getter=font) MAIFont* font;
@property(nullable, setter=setDelegate:, getter=delegate) id<MAITextFieldDelegate> delegate;
@property(setter=setAllowsEditingTextAttributes:, getter=allowsEditingTextAttributes) BOOL allowsEditingTextAttributes;
...
@property(nullable, setter=setBackgroundColor:, getter=backgroundColor) MAIColor* backgroundColor;
...
#if TARGET_OS_IPHONE
@interface MAITextField : UITextField<MAITextFieldProtocol>
#else
@interface MAITextField : NSTextField<MAITextFieldProtocol>
#endif
@end
