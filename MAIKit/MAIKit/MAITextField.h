...
@interface MAITextField : NSObject
-(instancetype)initWithFrame:(CGRect)frame NS_DESIGNATED_INITIALIZER;
-(instancetype)initWithCoder:(NSCoder*)aDecoder NS_DESIGNATED_INITIALIZER;
-(BOOL)becomeFirstResponder ;
-(BOOL)resignFirstResponder ;
@property(nonatomic, readwrite, nullable, strong) MAIColor* textColor;
@property(nonatomic, readwrite, nullable, weak) id<MAITextFieldDelegate> delegate;
...
#if TARGET_OS_IPHONE
@interface UITextField (MAIConversion)
#else
@interface NSTextField (MAIConversion)
#endif
-(MAITextField*) mai;
@end
