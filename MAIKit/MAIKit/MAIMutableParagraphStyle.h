...
-(void)addTabStop:(id<MAITextTabProtocol>)anObject;
-(void)removeTabStop:(id<MAITextTabProtocol>)anObject;
-(void)setParagraphStyle:(id<MAIParagraphStyleProtocol>)obj;
