...
@optional
-(CGFloat)collectionView:(id<MAICollectionViewProtocol>)collectionView layout:(id<MAICollectionViewLayoutProtocol>)collectionViewLayout minimumLineSpacingForSectionAtIndex:(NSInteger)section;
-(CGFloat)collectionView:(id<MAICollectionViewProtocol>)collectionView layout:(id<MAICollectionViewLayoutProtocol>)collectionViewLayout minimumInteritemSpacingForSectionAtIndex:(NSInteger)section;
