...
@optional
-(nullable id<MAIImageProtocol>)imageForBounds:(CGRect)imageBounds textContainer:(nullable id<MAITextContainerProtocol>)textContainer characterIndex:(NSUInteger)charIndex;
-(CGRect)attachmentBoundsForTextContainer:(nullable id<MAITextContainerProtocol>)textContainer proposedLineFragment:(CGRect)lineFrag glyphPosition:(CGPoint)position characterIndex:(NSUInteger)charIndex;
